...
<br>**11) 添加3DForcer转换器**
<br>在新的ExpressionEvaluator之后添加一个3DForcer转换器。这会将要素提升到所需的高度。在参数对话框中，将高程设置为“Attribute Value ”&gt;“TurnoutScaled”。

![](./Images/Img2.262.Ex7.3DForcerParameters.png)


**12）添加KMLPropertySetter**  
在3DForcer之后添加KMLPropertySetter转换器。该转换器允许我们在输出中设置3D块。设置几何对象参数如下：
